...
from scenarios.local_crm_runner import run_local_crm_with_compensation
...
def run_python() -> int:
    result = run_local_crm_with_compensation()
    summary = {
...
def main() -> int:
    ...
    if backend == "rust":
        ...
        return run_rust_bin("run_local_crm", ["--compensate"])
    return run_python()
